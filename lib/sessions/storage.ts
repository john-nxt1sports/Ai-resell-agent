...
import { encryptSessionData, decryptSessionData, generateSecureToken } from "./encryption";
...
export async function getSession(
  ...
  try {
    ...
    // Decrypt data
    const cookies = decryptSessionData(data.encrypted_cookies);
    const storage = decryptSessionData(data.encrypted_storage);
